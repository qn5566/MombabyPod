...
>>>>>>> origin/master
	...
	public void StyleSetting() {
		...
		vSlideHolder.setRightBehindContentView(R.layout.main_menu);
		//設定延遲時間
		vSlideHolder.setAnimationDurationLeft(500);
		vSlideHolder.setAnimationDurationRight(500);
