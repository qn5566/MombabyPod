...
public class RefreshableView extends LinearLayout implements View.OnTouchListener {
    ...
    /**
     * 判断是ListView还是GridView
     */
    private boolean isAListView;
    private boolean isAGridView;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && !loadOnce) {
            ...
            if(getChildAt(1).getClass().equals(ListView.class)) {
                isAListView = true;
                listView = (ListView) getChildAt(1);
                listView.setOnTouchListener(this);
            }
            if(getChildAt(1).getClass().equals(GridViewWithHeaderAndFooter.class)) {
                isAGridView = true;
                gridView = (GridViewWithHeaderAndFooter) getChildAt(1);
